...
contract UBSTV1 is Initializable, OwnableUpgradeable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable, ERC20SnapshotUpgradeable, ERC20VotesUpgradeable, ERC20CappedUpgradeable {

    function initialize() external initializer 
    {
        __Ownable_init();
        __ERC20_init("UBST", "UBST");
        __ERC20Burnable_init();
        __ERC20Permit_init("UBST");        
        __ERC20Capped_init((10 * 1e6 * 1e6));

        _mint(msg.sender, (3 * 1e6 * 1e6));
    }
